...
def main(argv):
    ...
    if use_minecraft:
        train_loader = dataset.create_minecraft_loader(training=True, use_camera_actions=FLAGS.use_minecraft_camera_actions)
        test_loader = dataset.create_minecraft_loader(training=False, use_camera_actions=FLAGS.use_minecraft_camera_actions)
    else:
